function drawShip_small2(pos,course,length,k)%WTF:k代表船号，不同的船号颜色不同
%WTF：船舶角度的转换
d=length/1852;
theta1=course-10;
theta2=course+10;
...
if k==1
    ...
    text(pos(1),pos(2)-0.1,['S_',num2str(k)],'Color','r');
elseif k==2
    ...
    text(pos(1),pos(2)+0.1,['S_',num2str(k)],'Color','g');
elseif k==3
    ...
    text(pos(1),pos(2)-0.1,['S_',num2str(k)],'Color','b');
else
    ...
    text(pos(1),pos(2)+0.1,['S_',num2str(k)],'Color','k');
end